...
class CausalSelfAttentionModern(nn.Module):
    def __init__(
        ...
        ), "n_head must be divisible by n_kv_heaad(GQA grouping)"
        self.group_size = self.n_head // self.n_kv_head
        self.d_head = n_embd // n_head

        # different projections for k and v while using GQA
    ...
    def forward(
        ...
        # if kv_cache is there concatenate it and if not pass it in k_all and v_all
        ...
        # repeat kv head to match q heads
